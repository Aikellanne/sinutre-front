...
export function LoginPage() {
  return (
    <>
      ...
      >
        {/* Painel azul (≈28% da largura, do protótipo) */}
        <div
          className="absolute inset-y-0 left-0 w-[28%]"
          style={{ backgroundColor: PRIMARY }}
        />

        {/* Marca SiNutre — topo da área branca, alinhada à esquerda (logo após o painel azul) */}
        <h1
        ...
        {/* Prato com pílulas — sobrepõe a borda azul/branca (vai de 0% a ≈44%) */}
        <div
...
function Pill({
  ...
  return (
    <span
      className={`absolute bg-white font-medium rounded-2xl px-5 py-2 text-sm whitespace-nowrap border border-slate-200 shadow-lg hover:shadow-xl transition-all duration-300 ${className}`}
